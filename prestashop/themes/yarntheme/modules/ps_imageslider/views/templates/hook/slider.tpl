...
{if $homeslider.slides}
  <div id="carousel" data-ride="carousel" class="carousel slide col-xs-12 col-sm-9" data-interval="{$homeslider.speed}" data-wrap="{(string)$homeslider.wrap}" data-pause="{$homeslider.pause}" data-touch="true">
